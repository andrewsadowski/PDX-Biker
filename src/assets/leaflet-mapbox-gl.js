  ...
  L.MapboxGL = L.Layer.extend({
    ...
    _update: function(e) {
      ...
      var size = this._map.getSize(),
        container = this._glContainer,
        gl = this._glMap,
        topLeft = this._map.containerPointToLayerPoint([
          0,
          0
        ]);
      ...
      var tr = gl.transform;
      tr.center = mapboxgl.LngLat.convert([
        center.lng,
        center.lat
      ]);
      ...
      if (
        gl.transform.width !== size.x ||
        gl.transform.height !== size.y
      ) {
        container.style.width = size.x + "px";
        container.style.height = size.y + "px";
        if (
          gl._resize !== null &&
          gl._resize !== undefined
        ) {
          gl._resize();
        } else {
          gl.resize();
